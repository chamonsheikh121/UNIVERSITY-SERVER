...
router.get(
  '/:id',
  academic_department_controller.get_single_academic_department,
);
router.patch(
  '/:id',
  validate_request(
    academic_department_zod_validation.update_academic_department_zod_validation_schema,
  ),
  academic_department_controller.update_academic_department,
);

router.post(
  '/create-academic-department',
  validate_request(
    academic_department_zod_validation.create_academic_department_zod_validation_schema,
  ),
